...
export default function Home() {
  ...
  const enviarDatos = (event) => {
    ...
    let datos = {};
    datos.numero_entrada = cantidad;
    datos.descripcion = descripcion;
    datos.status = 1;

    let entradaProductoService = new EntradaProductoService();
    entradaProductoService.saveEntradaProducto(datos).then(res => res.data);
    ...
    detalleEntradaService.saveDetalleEntrada(datos2).then(res => res.data);
  ...
  return (
     <div>
        <Head>
          <title>Entrada para: {producto.nombre}</title>
        </Head>
            ...
            <div class="row">
              ...
              <div class="col-12 p-2">
                <div class="alert alert-primary">
                  <center>
                    <h2>Entrada para: {producto.nombre}</h2>
                  </center>
                </div>
